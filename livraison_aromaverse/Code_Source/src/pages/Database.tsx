                   ...
                   <div className="space-y-6">
                      ...
                      <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                       ...
                       <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="p-4 bg-white/5 rounded-2xl border border-white/5 text-center group/spec hover:border-gold/30 transition-all">
                             <h4 className="text-[10px] text-muted-foreground uppercase tracking-widest font-black mb-1">Point d'ébul.</h4>
                             <p className="text-sm font-bold text-white">{selectedItem.boiling_point || "N/A"}</p>
                          </div>
                          <div className="p-4 bg-white/5 rounded-2xl border border-white/5 text-center group/spec hover:border-gold/30 transition-all">
                             <h4 className="text-[10px] text-muted-foreground uppercase tracking-widest font-black mb-1">Flash Point</h4>
                             <p className="text-sm font-bold text-white">{selectedItem.flash_point || "N/A"}</p>
                          </div>
                          <div className="p-4 bg-white/5 rounded-2xl border border-white/5 text-center group/spec hover:border-gold/30 transition-all">
                             <h4 className="text-[10px] text-muted-foreground uppercase tracking-widest font-black mb-1">Poids Mol.</h4>
                             <p className="text-sm font-bold text-white">{selectedItem.molecular_weight || "N/A"}</p>
                          </div>
                          <div className="p-4 bg-white/5 rounded-2xl border border-gold/20 text-center shadow-lg bg-gold/5 group/spec hover:bg-gold/10 transition-all">
