  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 font-body">
        <div className="glass-card w-full max-w-md p-10 rounded-[40px] border border-white/10 text-center">
          ...
          <p className="text-muted-foreground text-sm mb-8 font-medium">Contrôle de l'infrastructure globale NEXUS.</p>
          <form onSubmit={handleLogin} className="space-y-4">
            <Input type="email" placeholder="Email (mohamed@nexus-global.com)" value={email} onChange={(e) => setEmail(e.target.value)} required className="h-14 bg-black/40 border-white/10 rounded-2xl" />
