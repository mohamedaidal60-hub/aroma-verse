      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <p className={`text-xl text-muted-foreground mt-4 ${dir === "rtl" ? "font-arabic" : ""}`}>
          ...
          <Button 
            ...
            className="border-white/10 hover:border-gold hover:bg-gold/5 h-14 px-8 rounded-2xl group transition-all"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product) => (
            <div key={product.id} className="group glass-card rounded-[32px] overflow-hidden border border-white/5 hover:border-gold/30 transition-all duration-500 bg-black/20">
              <div className="h-64 overflow-hidden relative">
                <img src={product.image} alt={product.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 bg-black/60 backdrop-blur-md rounded-full text-[10px] font-bold text-gold border border-gold/20">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="font-bold text-lg text-white group-hover:text-gold transition-colors">{product.name}</h3>
                ...
                <Button 
                  ...
                  className="w-full h-12 bg-white/5 hover:bg-gold hover:text-black font-black text-xs uppercase tracking-widest rounded-xl border border-white/10 hover:border-gold transition-all flex items-center gap-2"
                >
