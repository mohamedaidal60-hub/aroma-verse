        ...
        <div className="relative h-[60vh] overflow-hidden mb-16">
           ...
           <div className="absolute bottom-0 left-0 w-full">
              <div className="container mx-auto px-4 max-w-4xl pb-10">
                 <Button 
                   variant="ghost" 
                   className="mb-8 text-gold hover:text-foreground font-bold h-12 rounded-xl group px-0"
                 ...
                 <div className="flex gap-4 mb-6">
                    ...
                    <span className="px-4 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-foreground/60 text-xs font-bold uppercase tracking-widest flex items-center gap-2"><Clock size={12}/> 12 MIN READ</span>
                 </div>

                 <h1 className="text-4xl md:text-7xl font-display font-black text-foreground mb-8 tracking-tighter leading-none italic">{post.title}</h1>
                 
                 <div className="flex flex-wrap items-center justify-between gap-6 border-t border-emerald-200 pt-8 mt-10">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          <p className="text-foreground font-black text-lg leading-none mb-1">Dr. S. Al-Dali</p>
                          <p className="text-xs text-emerald-700/70 uppercase tracking-widest font-bold">Expert Parfumeur Moléculaire</p>
                       </div>
                    </div>
                    <div className="flex gap-3">
                       <button className="w-12 h-12 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center justify-center hover:bg-gold hover:text-black transition-all" onClick={() => toast.success("Enregistré")}><Bookmark size={20}/></button>
                       <button className="w-12 h-12 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center justify-center hover:bg-gold hover:text-black transition-all" onClick={() => toast.success("Copié")}><Share2 size={20}/></button>
                    </div>
                 </div>
              </div>
           </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              ...
              <div className="lg:col-span-12 space-y-8 prose prose-invert prose-gold max-w-none">
                 <p className="text-2xl text-emerald-700/70 leading-relaxed italic mb-12 border-l-4 border-gold pl-8">
                 ...
                 <div className="text-xl text-foreground/80 leading-[1.8] font-light space-y-8">
                    {post.content ? (
                      ...
                      <>
                        ...
                        <div className="glass-card rounded-[40px] p-10 border border-gold/20 my-16 bg-gradient-to-br from-gold/5 to-transparent">
                           ...
                           <ul className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              <li className="flex flex-col"><span className="text-3xl font-black text-foreground">+14.2%</span><span className="text-xs text-emerald-700/70 uppercase tracking-widest">Croissance Marché Sourcing</span></li>
                              <li className="flex flex-col"><span className="text-3xl font-black text-foreground">87%</span><span className="text-xs text-emerald-700/70 uppercase tracking-widest">Adoption molécules durables</span></li>
                              <li className="flex flex-col"><span className="text-3xl font-black text-foreground">$4.2B</span><span className="text-xs text-emerald-700/70 uppercase tracking-widest">Investissements R&D Essences</span></li>
                              <li className="flex flex-col"><span className="text-3xl font-black text-foreground">2.4m</span><span className="text-xs text-emerald-700/70 uppercase tracking-widest">Références Moléculaires</span></li>
                           </ul>
                        </div>
                 ...
                 {/* Tags */}
                 <div className="flex flex-wrap gap-3 mt-20 pt-10 border-t border-emerald-100">
